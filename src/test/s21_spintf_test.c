...
START_TEST(sprintf_check) {
  ...
  // char str1t[400];
  // char str2t[400];
  // char *str3t = "%70c Test %-90c Test %080c Test %-065c Test %- 60c";
  // int at = 255;
  // ck_assert_int_eq(sprintf(str1t, str3t, at, at, at, at, at),
  //                  s21_sprintf(str2t, str3t, at, at, at, at, at));
  // ck_assert_pstr_eq(str1t, str2t);
  ...
  // char str1q[200];
  // char str2q[200];
  // char *str3q = "%+15u Test % -15u sdasda %+ 15d sdsad %- u";
  // int valq = -3231;
  // int val2q = -3231;
  // int val3q = 3231;
  // int val4q = 3231;
  // ck_assert_int_eq(sprintf(str1q, str3q, valq, val2q, val3q, val4q),
  //                  s21_sprintf(str2q, str3q, valq, val2q, val3q, val4q));
  // ck_assert_pstr_eq(str1q, str2q);
